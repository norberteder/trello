...
Trello.prototype.getOrgMembers = function (organization, callback) {
    return makeRequest(rest.get, this.uri + '/1/organizations/' + organization + '/members', {query: this.createQuery()}, callback);
};
